...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), e.s(["config", 0, { matcher: ["/((?!api|_next/static|_next/image|favicon.ico).*)"] }, "middleware", 0, function(e10) {
        ...
        let i2 = "marketing";
        return r2.startsWith("admin.") || "admin.sientoops.com" === r2 || "admin.localhost" === r2 ? i2 = "admin" : (r2.startsWith("academy.") || r2.startsWith("egitim.") || "academy.sientoops.com" === r2 || "egitim.sientoops.com" === r2 || "academy.localhost" === r2 || "egitim.localhost" === r2) && (i2 = "academy"), "academy" === i2 ? t10.pathname = `/academy${"/" === n2 ? "/dashboard" : n2}` : "admin" === i2 ? t10.pathname = `/admin${"/" === n2 ? "/dashboard" : n2}` : t10.pathname = `/marketing${"/" === n2 ? "" : n2}`, es.rewrite(t10);
      }], 96592);
...
var BuildId = "DypYC_MGjIY4Za6ep5Si5";
