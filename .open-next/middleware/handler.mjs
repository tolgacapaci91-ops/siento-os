...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      RegExp("\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)"), RegExp("\\n\\s+at __next_metadata_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_viewport_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_outlet_boundary__[\\n\\s]"), RegExp("\\n\\s+at __next_instant_validation_boundary__[\\n\\s]"), e.s(["config", 0, { matcher: ["/((?!api|_next/static|_next/image|favicon.ico).*)"] }, "middleware", 0, function(e10) {
        let t10 = e10.nextUrl.clone(), r2 = (e10.headers.get("host") || "").split(":")[0].toLowerCase(), n2 = t10.pathname;
        if (console.log(`[Middleware] Incoming: ${r2}${n2}`), n2.startsWith("/_next") || n2.startsWith("/api") || n2.includes(".") || n2.startsWith("/academy") || n2.startsWith("/admin") || n2.startsWith("/marketing")) return es.next();
        if ("/login" === n2 || "/forgot-password" === n2) return t10.pathname = `/marketing${n2}`, es.rewrite(t10);
        let i2 = "marketing", a2 = r2.includes("workers.dev");
        return r2.startsWith("admin.") || "admin.sientoops.com" === r2 ? i2 = "admin" : (r2.startsWith("academy.") || r2.startsWith("egitim.") || "academy.sientoops.com" === r2 || "egitim.sientoops.com" === r2 || a2 && ["/dashboard", "/workshops", "/courses", "/documents", "/useful-sites", "/favorites", "/profile", "/certificates", "/settings"].some((e11) => n2 === e11 || n2.startsWith(`${e11}/`))) && (i2 = "academy"), "academy" === i2 ? t10.pathname = `/academy${"/" === n2 ? "/dashboard" : n2}` : "admin" === i2 ? t10.pathname = `/admin${"/" === n2 ? "/dashboard" : n2}` : t10.pathname = `/marketing${"/" === n2 ? "" : n2}`, es.rewrite(t10);
      }], 96592);
...
var NextConfig = { "env": {}, "webpack": null, "typescript": { "ignoreBuildErrors": false }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 14400, "formats": ["image/webp"], "maximumRedirects": 3, "maximumResponseBody": 5e7, "dangerouslyAllowLocalIP": false, "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "localPatterns": [{ "pathname": "**", "search": "" }], "remotePatterns": [{ "protocol": "https", "hostname": "images.unsplash.com" }], "qualities": [75], "unoptimized": false, "customCacheHandler": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": { "serverFunctions": true, "browserToTerminal": "warn" }, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/home/runner/work/siento-os/siento-os", "cacheComponents": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 31536e3 } }, "cacheHandlers": {}, "experimental": { "appNewScrollHandler": false, "useSkewCookie": false, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "cachedNavigations": false, "partialFallbacks": false, "dynamicOnHover": false, "varyParams": false, "prefetchInlining": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "proxyPrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 3, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "strictRouteTypes": false, "viewTransition": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "reactDebugChannel": true, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "transitionIndicator": false, "gestureTransition": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "browserDebugInfoInTerminal": "warn", "lockDistDir": true, "proxyClientMaxBodySize": 10485760, "hideLogsAfterAbort": false, "mcpServer": true, "turbopackFileSystemCacheForDev": true, "turbopackFileSystemCacheForBuild": false, "turbopackInferModuleSideEffects": true, "turbopackPluginRuntimeStrategy": "childProcesses", "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "turbopack": { "root": "/home/runner/work/siento-os/siento-os" }, "distDirRoot": ".next" };
var BuildId = "SyD0P4BIcVvbhjmfVbN0F";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "priority": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/_global-error", "regex": "^/_global\\-error(?:/)?$", "routeKeys": {}, "namedRegex": "^/_global\\-error(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/academy", "regex": "^/academy(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy(?:/)?$" }, { "page": "/academy/certificates", "regex": "^/academy/certificates(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy/certificates(?:/)?$" }, { "page": "/academy/courses", "regex": "^/academy/courses(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy/courses(?:/)?$" }, { "page": "/academy/dashboard", "regex": "^/academy/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy/dashboard(?:/)?$" }, { "page": "/academy/documents", "regex": "^/academy/documents(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy/documents(?:/)?$" }, { "page": "/academy/favorites", "regex": "^/academy/favorites(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy/favorites(?:/)?$" }, { "page": "/academy/profile", "regex": "^/academy/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy/profile(?:/)?$" }, { "page": "/academy/useful-sites", "regex": "^/academy/useful\\-sites(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy/useful\\-sites(?:/)?$" }, { "page": "/academy/workshops", "regex": "^/academy/workshops(?:/)?$", "routeKeys": {}, "namedRegex": "^/academy/workshops(?:/)?$" }, { "page": "/admin", "regex": "^/admin(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin(?:/)?$" }, { "page": "/admin/badges", "regex": "^/admin/badges(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/badges(?:/)?$" }, { "page": "/admin/categories", "regex": "^/admin/categories(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/categories(?:/)?$" }, { "page": "/admin/courses", "regex": "^/admin/courses(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/courses(?:/)?$" }, { "page": "/admin/dashboard", "regex": "^/admin/dashboard(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/dashboard(?:/)?$" }, { "page": "/admin/documents", "regex": "^/admin/documents(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/documents(?:/)?$" }, { "page": "/admin/notifications", "regex": "^/admin/notifications(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/notifications(?:/)?$" }, { "page": "/admin/roles", "regex": "^/admin/roles(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/roles(?:/)?$" }, { "page": "/admin/settings", "regex": "^/admin/settings(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/settings(?:/)?$" }, { "page": "/admin/useful-sites", "regex": "^/admin/useful\\-sites(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/useful\\-sites(?:/)?$" }, { "page": "/admin/users", "regex": "^/admin/users(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/users(?:/)?$" }, { "page": "/admin/workshops", "regex": "^/admin/workshops(?:/)?$", "routeKeys": {}, "namedRegex": "^/admin/workshops(?:/)?$" }, { "page": "/api/v1/ai/chat", "regex": "^/api/v1/ai/chat(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/ai/chat(?:/)?$" }, { "page": "/api/v1/badges", "regex": "^/api/v1/badges(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/badges(?:/)?$" }, { "page": "/api/v1/categories", "regex": "^/api/v1/categories(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/categories(?:/)?$" }, { "page": "/api/v1/courses", "regex": "^/api/v1/courses(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/courses(?:/)?$" }, { "page": "/api/v1/documents", "regex": "^/api/v1/documents(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/documents(?:/)?$" }, { "page": "/api/v1/notifications", "regex": "^/api/v1/notifications(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/notifications(?:/)?$" }, { "page": "/api/v1/progress/document", "regex": "^/api/v1/progress/document(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/progress/document(?:/)?$" }, { "page": "/api/v1/progress/lesson", "regex": "^/api/v1/progress/lesson(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/progress/lesson(?:/)?$" }, { "page": "/api/v1/progress/profile", "regex": "^/api/v1/progress/profile(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/progress/profile(?:/)?$" }, { "page": "/api/v1/progress/workshop", "regex": "^/api/v1/progress/workshop(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/progress/workshop(?:/)?$" }, { "page": "/api/v1/quizzes/submit", "regex": "^/api/v1/quizzes/submit(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/quizzes/submit(?:/)?$" }, { "page": "/api/v1/stats/totals", "regex": "^/api/v1/stats/totals(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/stats/totals(?:/)?$" }, { "page": "/api/v1/upload", "regex": "^/api/v1/upload(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/upload(?:/)?$" }, { "page": "/api/v1/useful-sites", "regex": "^/api/v1/useful\\-sites(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/useful\\-sites(?:/)?$" }, { "page": "/api/v1/user/stats", "regex": "^/api/v1/user/stats(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/user/stats(?:/)?$" }, { "page": "/api/v1/users", "regex": "^/api/v1/users(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/users(?:/)?$" }, { "page": "/api/v1/workshops", "regex": "^/api/v1/workshops(?:/)?$", "routeKeys": {}, "namedRegex": "^/api/v1/workshops(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/marketing", "regex": "^/marketing(?:/)?$", "routeKeys": {}, "namedRegex": "^/marketing(?:/)?$" }, { "page": "/marketing/forgot-password", "regex": "^/marketing/forgot\\-password(?:/)?$", "routeKeys": {}, "namedRegex": "^/marketing/forgot\\-password(?:/)?$" }, { "page": "/marketing/login", "regex": "^/marketing/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/marketing/login(?:/)?$" }], "dynamic": [{ "page": "/academy/courses/[courseId]", "regex": "^/academy/courses/([^/]+?)(?:/)?$", "routeKeys": { "nxtPcourseId": "nxtPcourseId" }, "namedRegex": "^/academy/courses/(?<nxtPcourseId>[^/]+?)(?:/)?$" }, { "page": "/academy/courses/[courseId]/lesson/[lessonId]", "regex": "^/academy/courses/([^/]+?)/lesson/([^/]+?)(?:/)?$", "routeKeys": { "nxtPcourseId": "nxtPcourseId", "nxtPlessonId": "nxtPlessonId" }, "namedRegex": "^/academy/courses/(?<nxtPcourseId>[^/]+?)/lesson/(?<nxtPlessonId>[^/]+?)(?:/)?$" }, { "page": "/academy/workshops/[workshopId]", "regex": "^/academy/workshops/([^/]+?)(?:/)?$", "routeKeys": { "nxtPworkshopId": "nxtPworkshopId" }, "namedRegex": "^/academy/workshops/(?<nxtPworkshopId>[^/]+?)(?:/)?$" }, { "page": "/api/v1/badges/[id]", "regex": "^/api/v1/badges/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/badges/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/v1/categories/[id]", "regex": "^/api/v1/categories/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/categories/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/v1/courses/[id]", "regex": "^/api/v1/courses/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/courses/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/v1/courses/[id]/lessons", "regex": "^/api/v1/courses/([^/]+?)/lessons(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/courses/(?<nxtPid>[^/]+?)/lessons(?:/)?$" }, { "page": "/api/v1/documents/[id]", "regex": "^/api/v1/documents/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/documents/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/v1/lessons/[id]", "regex": "^/api/v1/lessons/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/lessons/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/v1/notifications/[id]/read", "regex": "^/api/v1/notifications/([^/]+?)/read(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/notifications/(?<nxtPid>[^/]+?)/read(?:/)?$" }, { "page": "/api/v1/progress/course/[courseId]", "regex": "^/api/v1/progress/course/([^/]+?)(?:/)?$", "routeKeys": { "nxtPcourseId": "nxtPcourseId" }, "namedRegex": "^/api/v1/progress/course/(?<nxtPcourseId>[^/]+?)(?:/)?$" }, { "page": "/api/v1/quizzes/course/[courseId]", "regex": "^/api/v1/quizzes/course/([^/]+?)(?:/)?$", "routeKeys": { "nxtPcourseId": "nxtPcourseId" }, "namedRegex": "^/api/v1/quizzes/course/(?<nxtPcourseId>[^/]+?)(?:/)?$" }, { "page": "/api/v1/useful-sites/[id]", "regex": "^/api/v1/useful\\-sites/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/useful\\-sites/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/v1/users/[id]", "regex": "^/api/v1/users/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/users/(?<nxtPid>[^/]+?)(?:/)?$" }, { "page": "/api/v1/workshops/[id]", "regex": "^/api/v1/workshops/([^/]+?)(?:/)?$", "routeKeys": { "nxtPid": "nxtPid" }, "namedRegex": "^/api/v1/workshops/(?<nxtPid>[^/]+?)(?:/)?$" }], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_global-error": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_global-error", "dataRoute": "/_global-error.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy", "dataRoute": "/academy.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy/certificates": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy/certificates", "dataRoute": "/academy/certificates.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy/courses": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy/courses", "dataRoute": "/academy/courses.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy/dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy/dashboard", "dataRoute": "/academy/dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy/documents": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy/documents", "dataRoute": "/academy/documents.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy/favorites": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy/favorites", "dataRoute": "/academy/favorites.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy/profile": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy/profile", "dataRoute": "/academy/profile.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy/useful-sites": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy/useful-sites", "dataRoute": "/academy/useful-sites.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/academy/workshops": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/academy/workshops", "dataRoute": "/academy/workshops.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin", "dataRoute": "/admin.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/badges": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/badges", "dataRoute": "/admin/badges.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/categories": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/categories", "dataRoute": "/admin/categories.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/courses": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/courses", "dataRoute": "/admin/courses.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/dashboard": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/dashboard", "dataRoute": "/admin/dashboard.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/documents": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/documents", "dataRoute": "/admin/documents.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/notifications": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/notifications", "dataRoute": "/admin/notifications.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/roles": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/roles", "dataRoute": "/admin/roles.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/settings": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/settings", "dataRoute": "/admin/settings.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/useful-sites": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/useful-sites", "dataRoute": "/admin/useful-sites.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/users": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/users", "dataRoute": "/admin/users.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/admin/workshops": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/admin/workshops", "dataRoute": "/admin/workshops.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/marketing": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/marketing", "dataRoute": "/marketing.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/marketing/forgot-password": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/marketing/forgot-password", "dataRoute": "/marketing/forgot-password.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/marketing/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/marketing/login", "dataRoute": "/marketing/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "27e14af93b7065983b6413fe5ff7419e", "previewModeSigningKey": "8546a763d2baa3b0bfcbae29a65f27ee786571b6099eedb769ae1c42b15778e3", "previewModeEncryptionKey": "0da8d4b4e7d99311e0a3ee95d1a36190e4265290fbbc4d244db13f2cd2c1e1bb" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge/chunks/node_modules_next_dist_esm_build_templates_edge-wrapper_0_kjzx3.js", "server/edge/chunks/[root-of-the-server]__0emy-m4._.js", "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js"], "name": "middleware", "page": "/", "entrypoint": "server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_0a9xbl8.js", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|favicon.ico).*))(\\.json|\\.rsc|\\.segments\\/.+\\.segment\\.rsc)?[\\/#\\?]?$", "originalSource": "/((?!api|_next/static|_next/image|favicon.ico).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "SyD0P4BIcVvbhjmfVbN0F", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "d/dXhT+k+JGkM4/URMSwB37jXAYyVSEa1yXoRDjJfFc=", "__NEXT_PREVIEW_MODE_ID": "27e14af93b7065983b6413fe5ff7419e", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "0da8d4b4e7d99311e0a3ee95d1a36190e4265290fbbc4d244db13f2cd2c1e1bb", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "8546a763d2baa3b0bfcbae29a65f27ee786571b6099eedb769ae1c42b15778e3" } } }, "sortedMiddleware": ["/"], "functions": {} };
var AppPathRoutesManifest = { "/_global-error/page": "/_global-error", "/_not-found/page": "/_not-found", "/academy/certificates/page": "/academy/certificates", "/academy/courses/[courseId]/lesson/[lessonId]/page": "/academy/courses/[courseId]/lesson/[lessonId]", "/academy/courses/[courseId]/page": "/academy/courses/[courseId]", "/academy/courses/page": "/academy/courses", "/academy/dashboard/page": "/academy/dashboard", "/academy/documents/page": "/academy/documents", "/academy/favorites/page": "/academy/favorites", "/academy/page": "/academy", "/academy/profile/page": "/academy/profile", "/academy/useful-sites/page": "/academy/useful-sites", "/academy/workshops/[workshopId]/page": "/academy/workshops/[workshopId]", "/academy/workshops/page": "/academy/workshops", "/admin/badges/page": "/admin/badges", "/admin/categories/page": "/admin/categories", "/admin/courses/page": "/admin/courses", "/admin/dashboard/page": "/admin/dashboard", "/admin/documents/page": "/admin/documents", "/admin/notifications/page": "/admin/notifications", "/admin/page": "/admin", "/admin/roles/page": "/admin/roles", "/admin/settings/page": "/admin/settings", "/admin/useful-sites/page": "/admin/useful-sites", "/admin/users/page": "/admin/users", "/admin/workshops/page": "/admin/workshops", "/api/v1/ai/chat/route": "/api/v1/ai/chat", "/api/v1/badges/[id]/route": "/api/v1/badges/[id]", "/api/v1/badges/route": "/api/v1/badges", "/api/v1/categories/[id]/route": "/api/v1/categories/[id]", "/api/v1/categories/route": "/api/v1/categories", "/api/v1/courses/[id]/lessons/route": "/api/v1/courses/[id]/lessons", "/api/v1/courses/[id]/route": "/api/v1/courses/[id]", "/api/v1/courses/route": "/api/v1/courses", "/api/v1/documents/[id]/route": "/api/v1/documents/[id]", "/api/v1/documents/route": "/api/v1/documents", "/api/v1/lessons/[id]/route": "/api/v1/lessons/[id]", "/api/v1/notifications/[id]/read/route": "/api/v1/notifications/[id]/read", "/api/v1/notifications/route": "/api/v1/notifications", "/api/v1/progress/course/[courseId]/route": "/api/v1/progress/course/[courseId]", "/api/v1/progress/document/route": "/api/v1/progress/document", "/api/v1/progress/lesson/route": "/api/v1/progress/lesson", "/api/v1/progress/profile/route": "/api/v1/progress/profile", "/api/v1/progress/workshop/route": "/api/v1/progress/workshop", "/api/v1/quizzes/course/[courseId]/route": "/api/v1/quizzes/course/[courseId]", "/api/v1/quizzes/submit/route": "/api/v1/quizzes/submit", "/api/v1/stats/totals/route": "/api/v1/stats/totals", "/api/v1/upload/route": "/api/v1/upload", "/api/v1/useful-sites/[id]/route": "/api/v1/useful-sites/[id]", "/api/v1/useful-sites/route": "/api/v1/useful-sites", "/api/v1/user/stats/route": "/api/v1/user/stats", "/api/v1/users/[id]/route": "/api/v1/users/[id]", "/api/v1/users/route": "/api/v1/users", "/api/v1/workshops/[id]/route": "/api/v1/workshops/[id]", "/api/v1/workshops/route": "/api/v1/workshops", "/favicon.ico/route": "/favicon.ico", "/marketing/(auth)/forgot-password/page": "/marketing/forgot-password", "/marketing/(auth)/login/page": "/marketing/login", "/marketing/page": "/marketing" };
